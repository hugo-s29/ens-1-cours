...
\begin{document}
  ...
  \begin{description}
    \item[ZF\,4'.\label{ZF4'}]
      ...
      pour toute formule $\varphi(y, v_1, \ldots, v_n)$ et tous ensembles $v_1, \ldots, v_{n+1}$, on a l'ensemble $x = \mleft\{\,y \in v_{n+1} \;\middle|\; \varphi(y, v_1, \ldots, v_n)\,\mright\}$
...
\big(\big(
  ...
  \begin{nota}[Réunion indexée]
    ...
    Pour $i \in I$, on note $a_i$, ou $a(i)$, pour l'unique objet $y$ tel que $(i, y) \in a$.
  \end{nota}
  ...
  \begin{prop}
    ...
    \begin{enumerate}
      ...
      \item $\beta \subset \alpha$ ssi $\beta = \alpha$ ou  $\beta \in \alpha$ ;
  ...
  \begin{thm}[Induction transfinie]
    ...
    \begin{itemize}
      ...
      \item pour tout ordinal $\alpha$ tel que, si tout $\beta < \alpha$ satisfait $\mathcal{P}$, alors $\alpha$ satisfait $\mathcal{P}$ :
        \[
