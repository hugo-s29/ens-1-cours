...
| $\mathtt{Var}$ : $\mathcal{V}$ -> $\mathsf{LEA}$.
  ...
  \begin{exm}
    ...
    \begin{figure}[H]
      ...
      \begin{tikzpicture}[sibling distance=30mm]
        \node[fill=deepblue,text=white,ellipse] (L0){\texttt{fun}}
        child { node[draw,rectangle] (L11) {$g$} }
          child { node[fill=deepblue,text=white,ellipse] (L12){\texttt{app}}
            child { node[fill=deepblue,text=white,ellipse] (L21){\texttt{var}} child { node[draw,rectangle] {$g$} }}
            child { node[fill=deepblue,text=white,ellipse] (L22){\texttt{app}}
              child { node[fill=deepblue,text=white,ellipse] (L31){\texttt{var}} child { node[draw,rectangle] {$g$} }}
              child { node[fill=deepblue,text=white,ellipse] (L32){\texttt{cst}} child { node[draw,rectangle] {$7$} }}
            }
          };
    ...
    \begin{figure}[H]
      ...
      \begin{tikzpicture}[sibling distance=30mm]
        ...
        child { node[draw,rectangle] (L11) {$x$} }
          child { node[fill=deepblue,text=white,ellipse] (L12){\texttt{add}}
            child { node[fill=deepblue,text=white,ellipse] (L21){\texttt{var}} child { node[draw,rectangle] {$x$} }}
            child { node[fill=deepblue,text=white,ellipse] (L22){\texttt{app}}
              child { node[fill=deepblue,text=white,ellipse] (L31){\texttt{var}} child { node[draw,rectangle] {$x$} }}
              child { node[fill=deepblue,text=white,ellipse] (L32){\texttt{cst}} child { node[draw,rectangle] {$7$} }}
            }
          };
        \tikzset{node distance = 1cm and 1cm}
  ...
  \begin{rmk}
    ...
    \begin{figure}[H]
      \centering
      \begin{tikzpicture}
        \node[fill=deepblue,text=white,ellipse] (T0) {\texttt{add}}
          child { node {$T_1$} }
          child { node {$T_2$} };
          \node[right of=T0] {$T_0$};
      ...
      $\quad$
      \begin{tikzpicture}
        \node[fill=deepblue,text=white,ellipse] (T0) {\texttt{app}}
          child { node {$T_1$} }
          child { node {$T_2$} };
          \node[right of=T0] {$T_0$};
      ...
      $\quad$
      \begin{tikzpicture}
        \node[fill=deepblue,text=white,ellipse] (T0) {\texttt{fun}}
          child { node {$T_1$} }
          child { node {$T_2$} };
          \node[right of=T0] {$T_0$};
