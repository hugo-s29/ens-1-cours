...
\begin{document}
  ...
  \begin{exm}
    ...
    Si on a $i \ge 0$ et on a $1 \le 2$ alors $i \le 2 i$ et par multiplication par $i$ on a $-1 \le -2$, absurde !
  ...
  \begin{defn}
    ...
    \begin{itemize}
      ...
      \item \textit{reste modifié} $\mathrm{MR}(P, Q)$ :\\
        ...
        \[ n = \deg P \ge m = \deg Q\]
        alors $\mathrm{MR}(P, Q)$ est l'unique polynôme de $\mathds{Z}[\bar{Y}][X]$ de degré $r < m$ tel qu'il existe $L \in \mathds{Z}[\bar{Y}][X]$ et 
        \[
  ...
  \begin{lem}[Informel]
    À partir d'un ensemble fini de polynômes $S$, on obtient en temps fini un ensemble fini de polynômes $\mathrm{BC}(S)$ de degré $0$ en appliquant les quatre opérations $\mathrm{D}$, $\mathrm{E}$, $\mathrm{O}$ et $\mathrm{MR}$.
  ...
  \begin{rmk}[Conjecture (problème 16 de la liste de Steve Smale)]
    En caractéristique $0$, $\operatorname{Jac} P$ non nul implique  $P$ injectif.
