...
\big(\big(
      ...
      \big)\\
      \vertical\to\\
      \exists a_{n+1} \: \forall a_{n+2} (a_{n+2} \in a_{n+1} \leftrightarrow \exists w_0 \: w_0 \in a_0 \land \varphi(w_0, a_{n+2}, v_1, \ldots, v_n))\big)
  .\end{gather*}
  ...
  Soit $Y \subseteq X$ est totalement ordonné. Montrons que $Y$ a un majorant dans $X$.
