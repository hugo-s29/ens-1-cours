...
\begin{document}
  ...
  \begin{prv}
    ...
    \begin{enumerate}
      ...
      \item \label{item:plus-comm-2}
        ...
        \end{itemize}
        \[
          \succ(x \oplus (\succ y)) \underset {\text{\peano{A5}}} = \succ \succ (x \oplus y) \underset{\text{hyp}} = \succ((\succ x) \oplus y) \underset {\text{\peano{A5}}} (\succ x) = \oplus (\succ y)
        .\]
  ...
  \begin{prv}
    ...
    ,\]
    où l'on note $\forall z < y, \: H$ pour  $\forall z \: ((\exists h \: \lnot (h = \repr{0}) \land z \oplus h = y) \to H)$.
 ...
 \begin{prv}
   ...
   B(x_0, i, a, b) := \exists x_4 \: \big(b = x_4 \otimes \succ (a \otimes (\succ i)) \land x_4 < \succ(x \otimes \succ i)\big)
   .\]
   On considère
   \[
