...
\begin{document}
  ...
  \begin{itemize}
    ...
    \item $\oplus$ et $\otimes$ sont deux symboles de fonction binaires.
  \end{itemize}
  ...
  \begin{rmk}
    ...
    \fitbox{
      $\forall x_1 \: \cdots \: \forall x_n \:
      \Big(F(\zero, x_1, \ldots, x_n) \to \forall x \: \big((\forall y < x, \: F(y, x_1, \ldots, x_n)) \to F(x, x_1, \ldots, x_n)\big)
      \to \forall x \: F(x, x_1, \ldots, x_n)
      \Big)$
    }
    %QV : L'hypothèse $F(\zero, x_1, \ldots, x_n)$ n'est même pas utile, c'est une conséquence de l'hérédité.
    \begin{itemize}
  ...
  \begin{prv}
    \begin{enumerate}
      ...
      \item Autre preuve, on considère un symbole de constante $c$ et on pose $\mathcal{L} := \mathcal{L}_0 \cup \{c\}$.
        ...
        Soit $T' \subseteq_\mathrm{fini} T$. On dispose de $n \in \mathds{N}$ tel que pour tout $k \in \mathds{N}$ tel que $\lnot(c = \repr{k}) \in T'$, $k \le n$.
        On étend l'interprétation $\mathds{N}$ de $\mathcal{L}_0$ en une interprétation de $\mathcal{L}$ en posant $c_{\mathds{N}} = n + 1$.
        $\mathds{N}$ est un modèle de $T'$.
  ...
  \begin{thm}
    ...
    \begin{enumerate}
      ...
      \item tout élément non nul est régulier pour la multiplication : 
        \[
        \mathcal{M} \models \forall x\: \forall y \: \forall z \: (\lnot (x = \zero) \to x \otimes y = x \otimes z \to y = z)
        \;;\]
  ...
  \begin{description}
    \item[Récurrence.]
      ...
      \end{itemize}
      %QV : Techniquement, tu ne fais pas le lien entre $f$ et la récurrence.
    \item[Composition.]
      ...
      %QV : Techniquement, tu ne définis pas la composée.
    \item[Schéma $\mu$.]
  ...
  \begin{rmk}
    \begin{itemize}
      ...
      \item \textit{Rappel}.
        Une fonction $f : \mathds{N}^p \to \mathds{N}$ totale est représentée par la formule $F(x_0, \ldots, x_p)$ de $\mathcal{L}_0$ si pour tout $p$-uplet d'entiers $(n_1, \ldots, n_p)$ on a :
        \[
        \mathcal{P}_0 \vdash \forall y \: \big( F(y, \repr {n_1}, \ldots, \repr{n_p}) \leftrightarrow y = \repr{f(n_1, \ldots, n_p)} \big)
        .\] 
      \item \textit{Rappel}.
      ...
      \item \textit{Rappel}.
        ...
        \end{itemize}
        %QV : Vu la longueur de ton cours, je ne pense pas que ces rappels soient nécessaires.
    \end{itemize}
  \end{rmk}
  ...
  \begin{prv}
    ...
    \[
    H(x_0, \ldots, x_p) := \exists y_0\: \cdots \: \exists y_n \: \big(
      G(x_0, y_1, \ldots, y_n) \land \bigwedge_{1 \le i \le  n} F_i(y_i, x_1, \ldots, x_p)
    \big)
    %QV : La formule déborde dans la marge.
    .\]
    Pour tous entiers $n_1, \ldots, n_{\max(p, n)}$ :
    \begin{itemize}
    ...
    \]  ou encore ssi $y = h(n_1,\ldots,n_p)$.
    On conclut \[
  ...
  \begin{prv}
    ...
    .\]
  %QV : Dans la définition, c'est la dernière variable que tu minimises.
    ...
    %QV : La formule dépasse dans la marge.
    ,\]
 ...
 \begin{prv}
   ...
   est vraie.
   Montrons que $F$ représente $f$.
   %QV : Est-ce que ce n'est pas ce que tu viens de faire avec l'équivalence précédente ?
 ...
 \begin{lem}
   ...
   \end{itemize}
   %QV : Il y a quelques lignes qui dépassent.
 \end{lem}
 \begin{prv}
 ...
 \begin{prv}
   ...
   \begin{itemize}
     ...
     \item sinon\\ {\small $\mathrm{Subst_t}(n, y, x) := \alpha_3(\mathrm{Subst_t}(n, y, \beta_3^1(x)), \mathrm{Subst_t}(n, y, \beta_3^2(x)), \beta_3^3(x))$}~;
       %QV : Les deux équations précédentes débordent.
   \end{itemize}
 ...
 \begin{rmk}
   ...
   %QV : J'ai du mal à comprendre ce qui n'est pas vrai, vu que tu répètes le théorème.
 ...
 \begin{prv}
   ...
   %QV : C'est l'un des points cruciaux de la preuve...
 \end{prv}
